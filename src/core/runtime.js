...
const plotTrashKindFilter = document.querySelector("#plotTrashKindFilter");
const operationHistoryWorkspace = document.querySelector("#operationHistoryWorkspace");
const operationHistoryTrigger = document.querySelector("#operationHistoryTrigger");
const operationHistoryCount = document.querySelector("#operationHistoryCount");
const operationHistoryDialog = document.querySelector("#operationHistoryDialog");
const operationHistoryClose = document.querySelector("#operationHistoryClose");
const operationHistoryList = document.querySelector("#operationHistoryList");
const operationHistoryStatus = document.querySelector("#operationHistoryStatus");
...
const appConfirmEyebrow = document.querySelector("#appConfirmEyebrow");
...
const appConfirmDetail = document.querySelector("#appConfirmDetail");
const appConfirmSymbol = document.querySelector("#appConfirmSymbol");
const appConfirmCancel = document.querySelector("#appConfirmCancel");
const appConfirmSubmit = document.querySelector("#appConfirmSubmit");
...
const timelineEditorPreviewViewport = document.querySelector("#timelineEditorPreviewViewport");
const timelineEditorPreview = document.querySelector("#timelineEditorPreview");
