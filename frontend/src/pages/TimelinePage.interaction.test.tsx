...
const snapshot: ProjectSnapshot = {
  ...
  timeline: {
    ...
    nodes: [
      { plotId: "plot:a", lineId: "line:main", storySortKey: "001" },
      { plotId: "plot:b", lineId: "line:main", storySortKey: "002" },
      { plotId: "plot:c", lineId: "line:main", storySortKey: "003" },
    ],
  },
...
describe("TimelinePage drag interaction", () => {
  ...
  it("restores with Escape, then keeps the swapped draft until the explicit save", async () => {
    renderTimeline();
    ...
    fireEvent.pointerMove(firstNode, { pointerId: 1, clientX: 360, clientY: 390 });
    expect(within(dialog).getByRole("heading", { name: /第 999 章/ })).toBeInTheDocument();
    expect(screen.getByText("第 12 章 → 第 999 章位置")).toBeInTheDocument();
    ...
    fireEvent.pointerMove(restoredNode, { pointerId: 2, clientX: 360, clientY: 390 });
    fireEvent.pointerUp(restoredNode, { pointerId: 2, clientX: 360, clientY: 390 });
    ...
    expect(request.payload.assignments).toEqual([
      { plotId: "plot:a", lineIds: ["line:main"], storySortKey: "003" },
      { plotId: "plot:b", lineIds: ["line:main"], storySortKey: "001" },
      { plotId: "plot:c", lineIds: ["line:main"], storySortKey: "002" },
    ]);
  });
